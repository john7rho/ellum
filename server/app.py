...
async def sync_site(request: Request, url_input: str = Form()):
    ...
    if url_input != "":
        cache_data = "https://adityarai10101--vectordbqaadi-queryurl.modal.run/?url=" + \
            str(url_input)
                ...
                if result.get("IsPartial") == False and result.get("Alternatives"):
                    ...
                    if time_diff > pause_threshold:
                        ...
                        async with aiohttp.ClientSession() as session:
                            ...
                            url = "https://adityarai10101--vectordbqaadi-queryreal.modal.run/?x=" + \
                                str(utterance)
